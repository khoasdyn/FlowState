...
```
FlowState/
├── FlowStateApp.swift                  # @main App entry point, WindowGroup + MenuBarExtra scenes
├── AppDelegate.swift                   # Quit protection via applicationShouldTerminate
├── AppConfig.swift                     # App-level enums (AppNavigationView, TimerState), duration presets, color theme
...
├── View/
│   ├── ContentView.swift               # Root view: navigation switch, SwiftData sync, session sheet
